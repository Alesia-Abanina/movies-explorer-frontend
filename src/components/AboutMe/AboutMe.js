    ...
    <Section title="Студент">
      <div className="about-me__block">
        <div className="about-me__info">
          ...
          <p className="about-me__description">Я родилась в Ростовской области, долгое время жила и работала в Москве. У меня есть муж
            и дочь. Я люблю путешевствовать и изучать новое. Недавно начала постигать веб разработку. Долгое время работала в авиации, но несколько лет назад переехала в Австралию.
